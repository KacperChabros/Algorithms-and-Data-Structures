...
public abstract class RbtMapPerformanceTest {
    ...
    public void countTreeHeightDependingOnDataSize() {
        ...
        ascending = 0;
        descending = maxSize;
        prefix = (int) Math.pow(10, String.valueOf(maxSize).length());
    ...
    abstract void putData(MapInterface<String, String> map, int nOfData);

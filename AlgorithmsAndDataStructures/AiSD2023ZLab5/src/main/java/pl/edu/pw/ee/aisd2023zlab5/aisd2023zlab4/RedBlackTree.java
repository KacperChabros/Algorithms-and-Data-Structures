...
import static pl.edu.pw.ee.aisd2023zlab5.aisd2023zlab4.Color.BLACK;
import static pl.edu.pw.ee.aisd2023zlab5.aisd2023zlab4.Color.RED;
...
public class RedBlackTree<K extends Comparable<K>, V> {
    ...
    private void validateKey(K key) {
        if (key == null) {
            throw new HuffmanException("Key cannot be null.", RedBlackTree.class.getName(),
                    "validateKey(K key)", IllegalArgumentException.class.getName());
        }
    }
    ...
    private void validateParams(K key, V value) {
        if (key == null || value == null) {
            throw new HuffmanException("Input params (key, value) cannot be null.", RedBlackTree.class.getName(),
                    "validateParams(K key, V value)", IllegalArgumentException.class.getName());
        }
    }
